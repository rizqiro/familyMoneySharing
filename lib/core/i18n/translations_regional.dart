...
const Map<String, String> banjarText = {
  ...
  'dashboard.where_went': 'Duitnya ka mana',
...
const Map<String, String> javaneseText = {
  ...
  'dashboard.where_went': 'Dhuwite menyang endi',
  'dashboard.latest': 'Paling anyar',
  'dashboard.left_to_spend': 'TURAHAN',
...
const Map<String, String> sundaneseText = {
  ...
  'dashboard.where_went': 'Duitna ka mana',
  'dashboard.latest': 'Panganyarna',
  'dashboard.left_to_spend': 'SÉSA',
